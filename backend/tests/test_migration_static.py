...
V2_COLUMNS = {
    ...
    "users": {
        ...
        "texture_preference", "texture_preference_source",
    ...
    "recommendation_items": {
        ...
        "fruit_snapshot", "daily_fact_snapshot",
    },
    "recommendations": {"scoring_model_version", "fruit_profile_version"},
    "fruit_selection_options": {"legacy_score_snapshot"},
}
V2_CONSTRAINTS = {
    "uq_fruits_code",
